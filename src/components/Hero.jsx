                ...
                <div className="relative z-10 flex text-center text-white justify-center h-full items-start">
                    <div className="mt-20 md:mt-32 lg:mt-54">
                        ...
                        <div className="flex flex-col md:flex-row justify-center mt-10 gap-5 mx-5">
                            <button 
                                className="bg-sky-600 px-5 py-2 md:px-5 md:text-lg lg:w-50 rounded-lg text-black hover:cursor-pointer hover:shadow-[0px_0px_60px_-15px_#009bf5] ease-in-out duration-500"
                            >
                                <a href="/Ivan_Armenta_Resume.pdf" download={"/Ivan_Armenta_Resume.pdf"}>
                                    View My Resume
                                </a>
                            </button>
                            <button 
                                className="bg-transparent px-7 py-3 md:py-4 lg:py-6 lg:px-10 md:text-xl rounded-md text-white hover:cursor-pointer border-1 border-sky-600 hover:bg-[#0b0e13] ease-in-out duration-500"
