            ...
            <section className='relative h-[90vh]'>
                ...
                <div className="relative z-10 flex text-center text-white justify-center h-full items-start">
                    <div className="mt-20 md:mt-32 lg:mt-54">
                        {/* Hero Text */}
                        <p className="text-4xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl px-2">Hi, I'm
                        ...
                        <p className="text-xl text-[#8998ad] my-0 px-3 md:px-10 lg:px-40 md:max-w-6xl text-pretty">
                        ...
                        {/* Social Icons */}
                        <div>
                            <GitHubIcon sx={{ color: '#bcbfc2', }}></GitHubIcon>
                            <LinkedIn sx={{ color: '#bcbfc2', }}></LinkedIn>
                            <Email sx={{ color: '#bcbfc2', }}></Email>
                        </div>
