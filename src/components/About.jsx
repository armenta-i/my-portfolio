        ...
        <section
            ...
            <div className='lg:flex xl:px-[12vw]'>
                <div className='align-middle'>
                    <p className="text-xl md:text-2xl text-[#8998ad] dark:text-[#8998ad] my-0 px-3 md:px-10 md:max-w-6xl text-pretty mb-8">
                ...
                <div 
                    className='md:grid md:grid-flow-col md:grid-rows-2 lg:pr-7'
                >
                    {/* Education card */}
                    {/* TODO: Fix the sizes of the cards to be equal always when reaching md size */}
                    <div 
